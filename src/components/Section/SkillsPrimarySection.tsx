...
import SkillsPrimaryImage from '../Images/SkillsPrimaryImage';

const SlCursor = dynamic(() => import('react-icons/sl').then(mod => mod.SlCursor));

const SkillsPrimarySection = () => {
                ...
                <div className="w-full md:w-full lg:w-1/2 h-1/2 md:h-full flex items-center justify-start">
                    <div className="flex flex-col items-start justify-center text-left">
                        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2 pt-5">
                            {t('skills-primary-section-title')}
                        </h1>
                        <p className="text-[12px] font-medium text-justify font-[Plus Jakarta Sans], sans-serif text-black/60 dark:text-white/60 overflow-hidden break-words">
                            {t('skills-primary-section-paragraph')} 
                        </p>
                        ...
                        >
                            <span className="text-sm font-medium flex items-center text-white">
                                {t('visit-skill-2')} <SlCursor className="ml-2" />
                            </span>
                        </button>
                    </div>
                </div>
...
export default SkillsPrimarySection;
