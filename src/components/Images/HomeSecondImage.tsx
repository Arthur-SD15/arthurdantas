const HomeSecondImage = () => {
    return (
        <div className="relative w-[60%] h-[60%] max-w-[396px] max-h-[396px] hover:opacity-90">
            ...
            <div className="absolute right-[-75%] md:right-[-20%] lg:right-[-40%] top-[-35%] lg:top-[-25%] w-[384px] h-[384px] bg-[url('/images/backgroundSecond.png')] bg-cover bg-center rotate-[25.73deg]"></div>
