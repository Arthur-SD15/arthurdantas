const SkillsPrimaryImage = () => {
    return (
        <div className="relative w-[75%] max-w-[260px] h-[75%] max-h-[350px] hover:opacity-90">
            ...
            <div className="absolute w-full top-[-10%] h-full min-h-full bg-[url('/images/skillsPrimaryImage.png')] bg-cover bg-center bg-no-repeat"></div>
        </div>
    )
}

export default SkillsPrimaryImage;
